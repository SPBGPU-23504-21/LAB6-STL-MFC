...
// LAB6(STL)-MFC.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLAB6STLMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CLAB6STLMFCApp

CLAB6STLMFCApp::CLAB6STLMFCApp()
{
...
// Единственный объект CLAB6STLMFCApp

CLAB6STLMFCApp theApp;


// инициализация CLAB6STLMFCApp

BOOL CLAB6STLMFCApp::InitInstance()
{
